...
const AboutSection = () => {
  return (
    <section id="about" className="section-padding bg-accent/10 dark:bg-accent/5 border-y-4 border-foreground relative overflow-hidden">
      ...
      {/* Background decorative elements */}
      <div className="absolute top-10 left-10 w-32 h-32 sm:w-40 sm:h-40 bg-primary/10 rounded-full blur-3xl animate-pulse-scale" />
      <div className="absolute bottom-10 right-10 w-40 h-40 sm:w-48 sm:h-48 bg-accent/10 rounded-full blur-3xl animate-pulse-scale" style={{ animationDelay: '2s' }} />
